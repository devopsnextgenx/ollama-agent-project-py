...
from ai.ui.novelSpec import App
import time

llmConfig = LLMProvider.create_llm_config(base_url="http://localhost:11434", model = "jaahas/tiger-gemma-v2")
...
async def main():
    ...
    app = App()
    app.mainloop()
    # novelSpec: NovelSpec =loadNovelSpec("./contents/.novel-spec.yml")
    ...
    # with open("./contents/novel.md", "w") as f:
